...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Anuj More"
    user-mail-address "anuj.more@grabtaxi.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/anuj.more/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/anuj.more/bin" "/profile/bin" "/Users/anuj.more/.npm-packages/bin" "/Users/anuj.more/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
