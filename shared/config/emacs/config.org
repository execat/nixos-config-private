...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Anuj More"
    user-mail-address "anujmorex@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/atm/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/atm/bin" "/profile/bin" "/Users/atm/.npm-packages/bin" "/Users/atm/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
